layui.config({
    ...
    qCommon.table({
        elem: '#security_user',
        url: layui.setter.domian + 'webUser/queryWebUserList',
        toolbar : "#toolbar",
        cols: [
            [
    ...
    function editPassword(data){
        ...
        layer.open({
            type: 2,
            title: '修改密码',
            content: 'editFrontUserPassword.html',
            area: ['500px', '480px'],
            btn: ['确定', '取消'],
            yes: function(index, layero) {
                var iframeWindow = window['layui-layer-iframe' + index],
                ...
                iframeWindow.layui.form.on('submit(security_submit_user)', function(data) {
                    ...
                    qCommon.ajax({
                        url: "/webUser/editWebUserByPassword",
                        data: {
                            username : username,
